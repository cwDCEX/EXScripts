...
# Setup the AD session
$ADSession = New-PSSession -ComputerName $ADServer -Credential $UserCredential

# Import the Active Directory module
Invoke-Command -Session $ADSession {Import-Module ActiveDirectory}

# Import the AD session
